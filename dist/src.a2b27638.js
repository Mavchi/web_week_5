...
var initMap = function initMap(geoData, positiveMigrationData, negativeMigrationData) {
  ...
  var getFeature = function getFeature(feature, layer) {
    ...
    layer.bindPopup("<ul><li>".concat(positiveMigrationData.dataset.value[index], " ").concat(negativeMigrationData.dataset.value[index], "</ul></li>"));
    console.log(feature); //console.log(positiveMigrationData)
    //console.log(geoData)
...
fetchData();
},{"./styles.css":"src/styles.css","./leaflet/leaflet.css":"src/leaflet/leaflet.css","./leaflet/leaflet":"src/leaflet/leaflet.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
